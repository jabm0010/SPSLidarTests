...
dataset2011Training = ""
dataset2017Training = ""
dataset2017500MillPoints = ""
dataset20171000MillPoints = ""
dataset20173000MillPoints = ""

datasets = [dataset2011Training, dataset2017Training,
            dataset2017500MillPoints, dataset20171000MillPoints]
...
# File in which to write the results
fileToWriteResults = "results.txt"
f = open(fileToWriteResults, "a")
f.write("TESTS\n")
...
def retrieveProcess():
    ...
    numberOfPointsToSurpass = 10000000
    filesDownloaded = 0
    ...
    for rootDB in jsondata:
        result = traverseOctree(rootDB)
        if result is not None:
            filesDownloaded = result[0]
            totalPointsDownloaded += result[1]
            totalDownloadRequestTime += result[2]
